...
class UIGS_ChainManagerBaseComponent;
...
class UIGS_PlayerManagerBaseComponent;
class UIGS_RandEventManagerBaseComponent;
class UIGS_StashManagerBaseComponent;
class UIGS_StatisticsManagerBaseComponent;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UIGS_StatisticsManagerBaseComponent* GetStatisticsManager();
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UIGS_PlayerManagerBaseComponent* GetPlayerManager();
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UIGS_ChainManagerBaseComponent* GetChainContractManager();

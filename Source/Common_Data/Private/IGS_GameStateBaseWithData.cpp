...
int32 AIGS_GameStateBaseWithData::GetReservedObjectiveValue() const {
    return 0;
}

FMETA_ReservedMissionRewardInfo AIGS_GameStateBaseWithData::GetReservedMissionRewardInfo() const {
...
EIGS_MissionType AIGS_GameStateBaseWithData::GetMissionType() const {
    return EIGS_MissionType::MT_UNKNOWN;
}

...
protected:
    ...
    TMap<EMETA_RespectLvl, int32> BossPointsPerRespect;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBossPointsPerRespect(const EMETA_RespectLvl inRespect) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBossPointsPerAsset() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetBossPointsFromFinalScore(const float inScore) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBossPointsForAccumulatedRespect(const EMETA_RespectLvl inStartingRespect, const EMETA_RespectLvl inEndRespect) const;

...
FGameplayTag UMETA_PlotlineAssetsDatabase::GetPreviousTier(FGameplayTag inAssetID) const {
    return FGameplayTag{};
}

FGameplayTagContainer UMETA_PlotlineAssetsDatabase::GetOtherTiers(FGameplayTag inAssetID) const {

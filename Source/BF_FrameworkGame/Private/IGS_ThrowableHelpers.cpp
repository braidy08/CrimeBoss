...
AIGS_ThrowableProjectileBase* UIGS_ThrowableHelpers::GetOwningThrowableByPawn(AIGS_GameCharacterFramework* inCharacter, TSubclassOf<AIGS_ThrowableProjectileBase> inThrowableClass) {
    return NULL;
}

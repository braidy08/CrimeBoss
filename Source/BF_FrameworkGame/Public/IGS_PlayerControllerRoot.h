...
#include "IGS_OnServerTimeWithRTTUpdatedDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_OnServerTimeWithRTTUpdated OnServerTimeWithRTTUpdated;
...
public:
    ...
    UFUNCTION(BlueprintCallable, Reliable, Server)
    void Server_RequestWorldTimeWithRTT(float inClientTimestamp);
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetServerWorldTimeWithRTT() const;
    ...
    UFUNCTION(BlueprintCallable, Client, Reliable)
    void Client_UpdateWorldTimeWithRTT(float inClientTimestamp, float inServerTimestamp);

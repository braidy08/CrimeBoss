...
void UMETA_BaseFPSMission::SetStealthCompletionFlag(const bool inStealthCompletionFlag) {
}
...
EMETA_StealthMode UMETA_BaseFPSMission::GetStealthMode() const {
    return EMETA_StealthMode::NotAvailable;
}

bool UMETA_BaseFPSMission::GetStealthCompletionFlag() const {
    return false;
}
...
EMETA_ReturnedDataProcessingMode UMETA_BaseFPSMission::GetReturnedDataProcessingMode() const {
...
FMETA_ReservedMissionRewardInfo UMETA_BaseFPSMission::GetReservedMissionRewardInfo() const {
    return FMETA_ReservedMissionRewardInfo{};
}
...
FMETA_FPSMissionInfo UMETA_BaseFPSMission::GetFPSMissionInfo() const {

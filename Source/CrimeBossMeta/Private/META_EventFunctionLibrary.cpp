...
void UMETA_EventFunctionLibrary::ToSaveStartedPlotlines(const TArray<TSoftObjectPtr<UStoryGraphManager>>& inStartedPlotlines, TArray<TSoftObjectPtr<UMETA_BaseStoryGraphManager>>& outStartedPlotlines) {
}
...
void UMETA_EventFunctionLibrary::FromSaveStartedPlotlines(const TArray<TSoftObjectPtr<UMETA_BaseStoryGraphManager>>& inStartedPlotlines, TArray<TSoftObjectPtr<UStoryGraphManager>>& outStartedPlotlines) {
}

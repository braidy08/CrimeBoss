...
void UIGS_LootManager::ForceSetMissionWeights(int32 inRequiredBags, int32 inTotalWeight) {
}
...
TMap<FGameplayTag, int32> UIGS_LootManager::CalculateReservedLootValues() const {

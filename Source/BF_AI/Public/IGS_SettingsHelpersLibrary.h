...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static bool GetIsInRangeOfCurrentTarget(AIGS_AIControllerBase* InController, const bool inForceMelee);
    ...
    UFUNCTION(BlueprintCallable)
    static float GetCombatRangeMin(AIGS_AIControllerBase* InController, const bool inRawValue);
    
    UFUNCTION(BlueprintCallable)
    static float GetCombatRangeMax(AIGS_AIControllerBase* InController, const bool inRawValue);

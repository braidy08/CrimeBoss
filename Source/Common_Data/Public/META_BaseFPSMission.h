...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetStealthCompletionFlag(const bool inStealthCompletionFlag);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_StealthMode GetStealthMode() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetStealthCompletionFlag() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FGameplayTag GetSelectedLoot();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_ReturnedDataProcessingMode GetReturnedDataProcessingMode() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMETA_RespectLvl GetRespectValueOnMissionSpawn();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_ReservedMissionRewardInfo GetReservedMissionRewardInfo() const;
    ...
    FMETA_FPSMissionInfo GetFPSMissionInfo() const;

...
public:
    ...
    void GetMissionMonetaryValues(UMETA_BaseMission* inMissionID, int32& outObjectiveValue, int32& outReservedValue, int32& outMaxValue, int32& outValueFromSuccess, int32& outTotalLootBagCount);

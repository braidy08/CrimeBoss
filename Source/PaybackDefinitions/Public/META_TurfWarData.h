...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bDisplayRelationShipTimer;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bDisplayTimerOnlyForBoss;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSet<EMETA_BossGangRelationship> RelationshipsWithVisibleTimer;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 DaysToDisplayRelationshipTimer;
...
public:
    ...
    bool ShouldGangRelationShipTimerBeDisplayed(const EMETA_BossGangRelationship inRelation, const int32 inDays, const bool inIsBoss) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FMETA_GangStrategyPropertiesConfig GetRageGangStrategyProperties(EMETA_Gang inGang) const;

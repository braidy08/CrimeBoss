...
#include "OnHighJitterDetectedSignatureDelegate.h"
#include "OnHighLatencyDetectedSignatureDelegate.h"
#include "OnPacketLossDetectedSignatureDelegate.h"
...
public:
    ...
    FOnPacketLossDetectedSignature OnPacketLossDetected;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnHighLatencyDetectedSignature OnHighLatencyDetected;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnHighJitterDetectedSignature OnHighJitterDetected;
    ...
    EIGS_NetworkMonitorStatus GetPacketLossState() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetNetworkPacketLoss() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EIGS_NetworkMonitorStatus GetLatencyState() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EIGS_NetworkMonitorStatus GetJitterState() const;

...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    bool IsFullOfAmmoOfType(TSubclassOf<UIGS_AmmoInventoryObject> inClass);
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UIGS_AmmoInventoryObject* GetAmmoObjectOf(TSubclassOf<UIGS_AmmoInventoryObject> inClass);
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    TArray<UIGS_InventoryObjectFramework*> GetAllItems();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    bool DoesHaveAmmoOfType(TSubclassOf<UIGS_AmmoInventoryObject> inClass);

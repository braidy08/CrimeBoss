...
#include "IGS_PlayerStatePreSeamlessTravelEventDelegate.h"
...
public:
    ...
    FIGS_PlayerStatePreSeamlessTravelEvent OnPlayerStatePreSeamlessTravelEvent;
...
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_PlayerStateData, meta=(AllowPrivateAccess=true))

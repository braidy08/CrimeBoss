...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_WaveManagerEventSignature OnIsGangsterOnlyChanged;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_IsGangsterOnly, meta=(AllowPrivateAccess=true))
    bool IsGangsterOnly;
...
static void SetIsGangsterOnly(const UObject* inWCO, bool inIsGangsterOnly);
    ...
    UFUNCTION(BlueprintCallable)
    void OnRep_IsGangsterOnly() const;

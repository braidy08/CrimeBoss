...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static float TruncateFloatWithPrecision(const float InValue, const int32 inDecimals);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static int32 CountNumberOfDecimals(const float InValue, const float inEpsilon);

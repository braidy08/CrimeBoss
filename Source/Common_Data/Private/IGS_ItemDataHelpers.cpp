...
FMETA_HeisterLoadout UIGS_ItemDataHelpers::MakeMetaHeisterLoadoutFromTags(UObject* inWCO, const FGameplayTag& inPrimaryWeapon, const FGameplayTag& inSecondaryWeapon, const FGameplayTag& inMeleeWeapon, const FGameplayTag& inEquipment, const TArray<FGameplayTag>& inUnlockedWeaponSkins) {

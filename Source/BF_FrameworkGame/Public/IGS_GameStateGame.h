...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UIGS_SequenceManager* SequenceManager;
...
protected:
    ...
    void Server_RemoveReservedLoot(FGameplayTag inLootType);
    ...
    UFUNCTION(BlueprintCallable, Reliable, Server)
    void Server_AddReservedLoot(FGameplayTag inLootType, int32 inPercentage);
...
public:
    ...
    UIGS_SequenceManager* GetSequenceManager() const;

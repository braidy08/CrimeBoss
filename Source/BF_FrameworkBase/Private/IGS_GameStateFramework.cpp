...
void AIGS_GameStateFramework::RemoveReservedLoot(UObject* inWCO, FGameplayTag inLootType) {
}
...
void AIGS_GameStateFramework::OnRep_MissionResult() {
}
...
TMap<FGameplayTag, int32> AIGS_GameStateFramework::GetReservedLoot() const {
...
void AIGS_GameStateFramework::AddReservedLoot(UObject* inWCO, FGameplayTag inLootType, int32 inPercentage) {
}
...
void AIGS_GameStateFramework::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    ...
    DOREPLIFETIME(AIGS_GameStateFramework, MissionResult);

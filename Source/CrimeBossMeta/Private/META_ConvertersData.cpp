...
TArray<FMETA_BossCharacterSave> UMETA_ConvertersData::ConvertBossCharactersToSave(const TArray<UMETA_BossCharacter*> inBossCharacters) {
    return TArray<FMETA_BossCharacterSave>();
}
...
TArray<UMETA_BossCharacter*> UMETA_ConvertersData::ConvertBossCharactersFromSave(UObject* inWCO, TArray<FMETA_BossCharacterSave>& inBossCharacters) {
    return TArray<UMETA_BossCharacter*>();
}

UMETA_BossCharacter* UMETA_ConvertersData::ConvertBossCharacterFromSave(UObject* inWCO, int32 inNumber, FMETA_BossCharacterSave& inBossCharacter) {
    return NULL;
}

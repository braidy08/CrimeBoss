...
#include "IGS_CharacterApplyGameplayEffectDelegate.h"
#include "IGS_CharacterHitEventSignatureDelegate.h"
#include "IGS_CharacterHolsterStartEventSignatureDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_GenericBoolEventSignature OnIsEscapingStatusChangedEvent;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    virtual UAbilitySystemComponent* GetAbilitySystemComponent() const override PURE_VIRTUAL(GetAbilitySystemComponent, return 0;);
};

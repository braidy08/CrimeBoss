...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 NumberOfMissionsAllowedPerDayByBoss;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FGameplayTagContainer> PrimaryWeapons;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FGameplayTagContainer> SecondaryWeapons;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FGameplayTagContainer> MeleeWeapons;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FGameplayTagContainer> Equipments;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 NumberOfMissionsAllowedPerDay;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 NumberOfAutoAddedEntitledCharacters;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<FGameplayTag, int32> NumberOfMissionsAllowedPerDayOverride;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    TMap<EMETA_RespectLvl, int32> GetSortedRespectThresholds() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfMissionsPerDayForCharacter(const FGameplayTag inCharacterTag) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfAutoAddedEntitledCharacters() const;

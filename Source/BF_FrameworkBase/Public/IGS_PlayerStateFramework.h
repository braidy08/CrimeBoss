...
#include "IGS_PlayerStateinitializedSignatureDelegate.h"
...
public:
    ...
    FIGS_PlayerStateinitializedSignature OnPlayerStateReadyEvent;
    
    AIGS_PlayerStateFramework(const FObjectInitializer& ObjectInitializer);

    UFUNCTION(BlueprintCallable)
    void SetSuccessfulShots(int32 inShots);
    ...
    UFUNCTION(BlueprintCallable)
    void SetMissedShots(int32 inShots);
    
    UFUNCTION(BlueprintCallable)
    void SetKillCount(int32 inCount);

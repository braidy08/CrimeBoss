...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void MoneySpent(int32 Money, int32 totalMoney, const FString& spentCategory, const FString& spentItem, const FString& spentItemQuality, int32 inAmount, const FString& inScreenTag, bool isMultiplayer);
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void CampaignStarted(FIGS_AnalyticsCommonMetaAttributes inMetaAttributes);
    
    UFUNCTION(BlueprintCallable)
    static void CampaignFinished_v3(const FString& CampaignMode, const FString& campaignResult, const int32 campaignScore, const FString& campaignGrade, const int32 finalScoreBossPoints, const int32 campainRunBossPoints, const int32 mpCashReward, FIGS_AnalyticsCommonMetaAttributes inMetaAttributes);
    
    UFUNCTION(BlueprintCallable)
    static void CampaignFinished(const FString& campaignResult, const int32 campaignScore, const FString& campaignGrade, const int32 finalScoreBossPoints, const int32 campainRunBossPoints, const int32 mpCashReward, FIGS_AnalyticsCommonMetaAttributes inMetaAttributes);

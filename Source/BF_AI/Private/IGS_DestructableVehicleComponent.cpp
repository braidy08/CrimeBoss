...
void UIGS_DestructableVehicleComponent::Multicast_ExplodeVehicle_Implementation(AController* inInstigator) {
}

void UIGS_DestructableVehicleComponent::ExplodeVehicle(AController* inInstigator) {
}

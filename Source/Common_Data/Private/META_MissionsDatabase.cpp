...
FMETA_BossKilledMissionOverride UMETA_MissionsDatabase::GetBossKilledMissionOverride(TSubclassOf<UMETA_MissionID> inMissionID, bool& outShouldOverride) {
    return FMETA_BossKilledMissionOverride{};
}

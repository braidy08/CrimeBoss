...
AIGS_IntelligentGameCharacter::AIGS_IntelligentGameCharacter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer.SetDefaultSubobjectClass<UIGS_DamageHandlerComponent>(TEXT("DamageHandlerComponent2"))) {
    ...
    this->TempKillDirection = EIGS_DeathDirection::DD_Default;
    this->TempKillState = EIGS_TPP_DeathStates::D_Stand;
    this->TempIsMeleeKill = false;
    ...
    this->EffectsHandlerComponent = CreateDefaultSubobject<UIGS_EffectsHandlerComponent>(TEXT("EffectsHandlerComponent"));
...
UIGS_BasherComponent* AIGS_IntelligentGameCharacter::GetCurrentBasher() {
    return NULL;
}

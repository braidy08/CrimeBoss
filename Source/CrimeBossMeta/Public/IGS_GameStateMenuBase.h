...
#include "MPLobbyTypeChangedDelegateDelegate.h"
#include "IGS_GameStateMenuBase.generated.h"

class AIGS_MenuSlotBase;
class APlayerState;
class UIGS_CameraSwitchManagerComponent;
...
public:
    ...
    FMPLobbyTypeChangedDelegate OnMPLobbyChangedEvent;
    ...
    void OnMPLobbyChanged(EIGS_MPLobbyType inLobbyType);
    
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, BlueprintPure)
    UIGS_UnlockManagerComponent* GetUnlockManagerComponent();
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UIGS_CameraSwitchManagerComponent* GetCameraSwitchManagerComponent();

...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void PrintExtraSessionSettingsArray(const TArray<FSessionPropertyKeyPair>& SettingsArray);
    ...
    UFUNCTION(BlueprintCallable)
    static FString GetInviteCodePossibleCharacters();
    
    UFUNCTION(BlueprintCallable)
    static int32 GetInviteCodeLength();

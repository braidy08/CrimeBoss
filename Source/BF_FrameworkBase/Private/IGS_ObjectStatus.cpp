...
void UIGS_ObjectStatus::ServerForceSetAllData(float inHealth, float inShield, float inMaxHealth, float inMaxShield, EIGS_HealthState inHealthState, const FIGS_HitInfo& inHitInfo, bool inAllowWhileDead) {
}

...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void ZiptieChanged_Event(const bool inIsZiptied);
...
public:
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void NearMiss(FVector inSourceLocation, FVector inDirectionFromHead, EIGS_AIHitReactionVariant inReactionDirection);

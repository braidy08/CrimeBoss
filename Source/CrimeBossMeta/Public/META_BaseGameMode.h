...
class UMETA_PlayerManagerComponent;
...
class UMETA_StatisticsManagerComponent;
class UMETA_UIEventsManagerComponent;
class UMETA_WarManagerComponent;
...
public:
    ...
    UMETA_WarManagerComponent* GetWarManagerComponent() const;
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    UMETA_UIEventsManagerComponent* GetUIEventsManagerComponent();
    
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, BlueprintPure)
    UMETA_StatisticsManagerComponent* GetStatisticsManagerComponent() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, BlueprintPure)
    UMETA_PlayerManagerComponent* GetPlayerManagerComponent() const;

...
public:
    ...
    static TArray<FMETA_PerkData> RecalculateRandomPerksAtLevel(UObject* inWCO, FGameplayTag inCharacterTag, int32 inCharacterLevel, const TArray<FMETA_PerkData>& inCurrentPerks, const TArray<FGameplayTag>& inMarketPoolPerks, const TArray<FGameplayTag>& inCrewPerks, int32 inPerkLimit);
    
    UFUNCTION(BlueprintCallable)
    static TArray<FMETA_PerkData> RecalculateBossRandomPerks(UObject* inWCO, FGameplayTag inCharacterTag, int32 inCharacterLevel, const TArray<FMETA_PerkData>& inCurrentPerks, int32 inPerkLimit);
    ...
    UFUNCTION(BlueprintCallable)
    static TArray<FMETA_PerkData> GenerateGenericCharacterPerksAtLevel(UObject* inWCO, FGameplayTag inCharacterTag, int32 inCharacterLevel, const TArray<FMETA_PerkData>& inCurrentPerks, const TArray<FGameplayTag>& inMarketPoolPerks, const TArray<FGameplayTag>& inCrewPerks, int32 inPerkLimit);

...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetGenericVariantID(const int32 inIndex, const bool inIgnoreSettings);
    ...
    UFUNCTION(BlueprintCallable)
    bool SelectEquipment(UMETA_Equipment* inCurrentEquipment, bool inSwapFromPreviousCharacter);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetGenericVariantID() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    ETextGender GetGender();
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetBaseMissionCutPercent() const;

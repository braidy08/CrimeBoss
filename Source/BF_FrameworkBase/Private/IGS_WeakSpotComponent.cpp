...
void UIGS_WeakSpotComponent::MessageToAll_WeakSpotCompromised_Implementation(const UPrimitiveComponent* inWeakSpotReference, const FIGS_HitInfo& inLastHitInfo) {
}

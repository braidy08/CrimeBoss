...
void UMETA_Character::SetGenericVariantID(const int32 inIndex, const bool inIgnoreSettings) {
}
...
bool UMETA_Character::SelectEquipment(UMETA_Equipment* inCurrentEquipment, bool inSwapFromPreviousCharacter) {
    return false;
}
...
void UMETA_Character::RefreshGenericVariantID() {
}
...
bool UMETA_Character::IsDismissable() const {
    return false;
}
...
int32 UMETA_Character::GetMutableIndex() const {
    return 0;
}
...
int32 UMETA_Character::GetGenericVariantID() const {
    return 0;
}

ETextGender UMETA_Character::GetGender() {
...
int32 UMETA_Character::GetBaseMissionCutPercent() const {
    return 0;
}

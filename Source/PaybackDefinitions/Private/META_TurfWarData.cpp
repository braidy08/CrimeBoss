...
UMETA_TurfWarData::UMETA_TurfWarData() {
    ...
    this->bDisplayRelationShipTimer = false;
    this->bDisplayTimerOnlyForBoss = false;
    this->DaysToDisplayRelationshipTimer = 6;
...
bool UMETA_TurfWarData::ShouldGangRelationShipTimerBeDisplayed(const EMETA_BossGangRelationship inRelation, const int32 inDays, const bool inIsBoss) const {
    return false;
}
...
FMETA_GangStrategyPropertiesConfig UMETA_TurfWarData::GetRageGangStrategyProperties(EMETA_Gang inGang) const {

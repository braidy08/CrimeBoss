...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FGameplayTag killed_soldiers_tag;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfSuccessfulTurfwarDefenses() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfSuccessfulTurfwarAttacks() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfSuccessfulFPSMissions() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetNumberOfAllSuccessfulMissions() const;
    ...
    UFUNCTION(BlueprintCallable)
    void AddTurfWarMissionDataToStatistic(UMETA_BaseMission* inMission, TMap<FGameplayTag, int32> inFPSData, FIGS_FPS2Meta_Data inFPSEconomyData, FIGS_SharedMetaTransfer_Data inShareData);
    ...
    UFUNCTION(BlueprintCallable)
    void AddIsolatedTurfsToStatistic(UMapTile* inTile);
    ...
    UFUNCTION(BlueprintCallable)
    void AddFPSMissionDataToStatistic(UMETA_BaseMission* inMission, TMap<FGameplayTag, int32> inFPSData, FIGS_FPS2Meta_Data inFPSEconomyData, FIGS_SharedMetaTransfer_Data inShareData, int32 inCountOfStars, FMETA_FinishedMissionInfo& inFinishedMissionInfo);

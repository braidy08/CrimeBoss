...
#include "IGS_ActiveEquipmentDurationIncreasedDelegate.h"
#include "IGS_DeathCameraEndedSignatureDelegate.h"
#include "IGS_IntelligentGameCharacter.h"
#include "IGS_OnPlayerWantsToAttackSignatureDelegate.h"
#include "IGS_OnServerPerkPickedUpDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_ActiveEquipmentDurationIncreased OnActiveEquipmentDurationIncreased;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FGameplayAbilitySpecHandle RunningAbilitySpecHandle;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FActiveGameplayEffectHandle CurrentEquipmentGameplayEffect;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetEquipmentGameplayEffect(FActiveGameplayEffectHandle inEffect);

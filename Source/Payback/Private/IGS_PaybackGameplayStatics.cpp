...
void UIGS_PaybackGameplayStatics::SeamlessRestartGame(UObject* inWCO) {
}
...
void UIGS_PaybackGameplayStatics::GetPlayerLoadoutFromAILoadoutHolder(const UObject* inWCO, const FIGS_AILoadoutHolder& inLoadoutHolder, TSubclassOf<UMETA_WeaponInventoryObject>& outPrimary, TSubclassOf<UMETA_WeaponInventoryObject>& outSecondary, TSubclassOf<UMETA_WeaponInventoryObject>& outMelee, TSubclassOf<UIGS_EquipmentInventoryObject>& outEquipment, bool inIsStory) {
}

void UIGS_PaybackGameplayStatics::GetPlayerLoadoutFromAICharacter(const UObject* inWCO, AIGS_IntelligentGameCharacter*& inCharacter, TSubclassOf<UMETA_WeaponInventoryObject>& outPrimary, TSubclassOf<UMETA_WeaponInventoryObject>& outSecondary, TSubclassOf<UMETA_WeaponInventoryObject>& outMelee, TSubclassOf<UIGS_EquipmentInventoryObject>& outEquipment) {
}
...
bool UIGS_PaybackGameplayStatics::CanPlayerActivateEquipment(AIGS_PlayerCharacter* inCharacter) {
    return false;
}

...
bool UIGS_UnlockManager::IsUnlockableEventItem(const FGameplayTag inTagID) const {
    return false;
}
...
bool UIGS_UnlockManager::HasSomePendingItemsByInventorySlot(const EIGS_InventorySlot inSlot) {
    return false;
}

bool UIGS_UnlockManager::HasSomePendingItemsByCategory(const EIGS_UnlockCategory inCategory) const {
    return false;
}
...
FGameplayTag UIGS_UnlockManager::GetOnlineFactIDForItem(const FIGS_UnlockItemInfo& inItemInfo) {
    return FGameplayTag{};
}
...
TArray<FIGS_UnlockItemInfo> UIGS_UnlockManager::GetAllUnlockedItemsByCategory(EIGS_UnlockCategory inUnlockCategory, bool inMustBeUnlockable) const {
    return TArray<FIGS_UnlockItemInfo>();
}
...
void UIGS_UnlockManager::FilterEventItemsByBehavior(TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos, const TSet<EIGS_EventItemBehavior> inAllowedBehavior) {
}

void UIGS_UnlockManager::FilterEventItems(TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos) {
}

void UIGS_UnlockManager::FilterEntitledItems(TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos) {
}

void UIGS_UnlockManager::FilterDefaultUnlockedItems(TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos) {
}

...
void UIGS_GameScreenHandler::SetSupportedInputCategories(TArray<EIGS_InputCategory> inCategories) {
}
...
void UIGS_GameScreenHandler::RequestCloseScreen(UObject* inWCO, UIGS_Screen* inScreen, bool destroyAfterClose, bool refreshFocusAfterClose, bool openPreviousScreen) {
}

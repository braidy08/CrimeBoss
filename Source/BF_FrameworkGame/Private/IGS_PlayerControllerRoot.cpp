...
AIGS_PlayerControllerRoot::AIGS_PlayerControllerRoot(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->HUDReconstructTimePeriod = 2.00f;
...
void AIGS_PlayerControllerRoot::Server_RequestWorldTimeWithRTT_Implementation(float inClientTimestamp) {
}
...
float AIGS_PlayerControllerRoot::GetServerWorldTimeWithRTT() const {
    return 0.0f;
}
...
void AIGS_PlayerControllerRoot::Client_UpdateWorldTimeWithRTT_Implementation(float inClientTimestamp, float inServerTimestamp) {
}

...
int32 UMETA_BossLevelData::GetBossPointsPerRespect(const EMETA_RespectLvl inRespect) const {
    return 0;
}
...
float UMETA_BossLevelData::GetBossPointsFromFinalScore(const float inScore) const {
    return 0.0f;
}

int32 UMETA_BossLevelData::GetBossPointsForAccumulatedRespect(const EMETA_RespectLvl inStartingRespect, const EMETA_RespectLvl inEndRespect) const {
    return 0;
}

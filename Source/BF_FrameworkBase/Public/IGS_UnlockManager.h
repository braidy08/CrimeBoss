...
class UIGS_EventItems;
class UIGS_OnlineFacts;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_OnlineFacts* m_OnlineFacts;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_Entitlements* m_Entitlements;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_EventItems* m_EventItems;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool IsUnlockableEventItem(const FGameplayTag inTagID) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool HasSomePendingItemsByInventorySlot(const EIGS_InventorySlot inSlot);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool HasSomePendingItemsByCategory(const EIGS_UnlockCategory inCategory) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FGameplayTag GetOnlineFactIDForItem(const FIGS_UnlockItemInfo& inItemInfo);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    TArray<FIGS_UnlockItemInfo> GetAllUnlockedItemsByCategory(EIGS_UnlockCategory inUnlockCategory, bool inMustBeUnlockable) const;
    ...
    UFUNCTION(BlueprintCallable)
    void FilterEventItemsByBehavior(UPARAM(Ref) TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos, const TSet<EIGS_EventItemBehavior> inAllowedBehavior);
    
    UFUNCTION(BlueprintCallable)
    void FilterEventItems(UPARAM(Ref) TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos);
    
    UFUNCTION(BlueprintCallable)
    void FilterEntitledItems(UPARAM(Ref) TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos);
    
    UFUNCTION(BlueprintCallable)
    void FilterDefaultUnlockedItems(UPARAM(Ref) TArray<FIGS_UnlockItemInfo>& inOutUnlockItemInfos);

...
#include "IGS_BoolChangedSignatureDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    AActor* DistanceToTargetActor;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FVector DistanceToTargetActorLastLocation;
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_BoolChangedSignature OnIsFrenziedChanged;
...
protected:
    ...
    UFUNCTION(BlueprintCallable)
    void OnFrenzyTagChanged(const FGameplayTag inGameplayTag, int32 inAmount);

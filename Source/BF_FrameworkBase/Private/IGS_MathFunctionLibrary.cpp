...
float UIGS_MathFunctionLibrary::TruncateFloatWithPrecision(const float InValue, const int32 inDecimals) {
    return 0.0f;
}
...
int32 UIGS_MathFunctionLibrary::CountNumberOfDecimals(const float InValue, const float inEpsilon) {
    return 0;
}

...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool IsTagOfLevelledPerk(const FGameplayTag inPerkTag);
    ...
    UFUNCTION(BlueprintCallable)
    static TArray<EMETA_ItemQuality> GetQualitiesFromBitmask(const int32 inBitmask);
    ...
    UFUNCTION(BlueprintCallable)
    static EMETA_ItemQuality GetHighestQualityFromBitmask(const int32 inBitmask);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FText GetFormattedBonusObjectiveDescription(const FMETA_ObjectiveConfig& InConfig);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FGameplayTagContainer FilterByPerk(const FGameplayTagContainer& inPerkContainer, const FGameplayTag inPerkTag);

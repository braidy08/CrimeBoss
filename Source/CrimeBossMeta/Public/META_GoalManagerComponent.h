...
#include "META_SeenGoalsChangedDelegate.h"
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<TSubclassOf<UMETA_BaseGoal>> SeenGoals;
...
public:
    ...
    FMETA_SeenGoalsChanged OnSeenGoalsChanged;
    ...
    void RemoveSeenGoalId(TSubclassOf<UMETA_BaseGoal> inGoalID);
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool AreAnyGoalsNotSeen(TArray<UMETA_BaseGoal*> inGoals) const;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void AddGoalsToSeenGoals(TArray<UMETA_BaseGoal*> inGoals);
    
    UFUNCTION(BlueprintCallable)
    void AddGoalIdToSeenGoals(TSubclassOf<UMETA_BaseGoal> inGoalID);
    
    UFUNCTION(BlueprintCallable)
    void AddGoalIdsToSeenGoals(TArray<TSubclassOf<UMETA_BaseGoal>> inGoalIDs);

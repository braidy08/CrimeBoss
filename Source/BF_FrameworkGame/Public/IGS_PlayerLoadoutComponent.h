...
#include "IGS_OnEquipmentGEAppliedDelegate.h"
...
class UIGS_GameplayAbilityEquipmentBase;
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_OnEquipmentGEApplied OnEquipmentGEApplied;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<UGameplayEffect> PsychopathGE;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UIGS_GameplayAbilityEquipmentBase* m_CurrentEquipmentAbility;
...
protected:
    ...
    void Server_SelfHeal(float inAmount);
...
protected:
    ...
    UFUNCTION(BlueprintCallable)
    void ForceUpdateEquipmentState();

...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetDetectionStartThreshold() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetBotCatchingUpDetectionMultiplier() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetAnimationOffsetMaxMultiplier() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FVector2D GetAnimationOffsetAngleRange() const;

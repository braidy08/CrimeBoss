...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static float GetDamageScaledByRadius(float DistanceFromEpicenter, float BaseDamage, float MinimumDamage, float DamageInnerRadius, float DamageOuterRadius, float DamageFalloff);

...
void UIGS_BadFlyGameplayStaticsFramework::PrintExtraSessionSettingsArray(const TArray<FSessionPropertyKeyPair>& SettingsArray) {
}
...
void UIGS_BadFlyGameplayStaticsFramework::NotifyStreamingManagerPrimitiveUpdated(const UPrimitiveComponent* inPrimitive) {
}
...
bool UIGS_BadFlyGameplayStaticsFramework::IsSessionOwnerBlocked(const UObject* inWCO, const FBlueprintSessionResult& Result) {
    return false;
}
...
FString UIGS_BadFlyGameplayStaticsFramework::GetInviteCodePossibleCharacters() {
    return TEXT("");
}

int32 UIGS_BadFlyGameplayStaticsFramework::GetInviteCodeLength() {
    return 0;
}
...
FString UIGS_BadFlyGameplayStaticsFramework::GenerateInviteCode() {
    return TEXT("");
}

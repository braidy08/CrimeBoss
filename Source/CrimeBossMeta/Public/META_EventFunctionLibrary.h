...
public:
    ...
    static void ToSaveStartedPlotlines(const TArray<TSoftObjectPtr<UStoryGraphManager>>& inStartedPlotlines, TArray<TSoftObjectPtr<UMETA_BaseStoryGraphManager>>& outStartedPlotlines);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static void FromSaveStartedPlotlines(const TArray<TSoftObjectPtr<UMETA_BaseStoryGraphManager>>& inStartedPlotlines, TArray<TSoftObjectPtr<UStoryGraphManager>>& outStartedPlotlines);

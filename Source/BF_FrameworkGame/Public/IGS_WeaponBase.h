...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetCurrentAttributeMultipliers(float& outWeaponDamageAttrib, float& outHipFireSpreadAttrib, float& outAdsSpreadAttrib, float& outIdleSwayIntensityAttrib, float& outAdsSpeedAttrib, float& outReloadSpeedAttrib, float& outRPMMultAttrib) const;

...
void UMETA_GoalManagerComponent::RemoveSeenGoalId(TSubclassOf<UMETA_BaseGoal> inGoalID) {
}
...
bool UMETA_GoalManagerComponent::AreAnyGoalsNotSeen(TArray<UMETA_BaseGoal*> inGoals) const {
    return false;
}
...
void UMETA_GoalManagerComponent::AddGoalsToSeenGoals(TArray<UMETA_BaseGoal*> inGoals) {
}

void UMETA_GoalManagerComponent::AddGoalIdToSeenGoals(TSubclassOf<UMETA_BaseGoal> inGoalID) {
}

void UMETA_GoalManagerComponent::AddGoalIdsToSeenGoals(TArray<TSubclassOf<UMETA_BaseGoal>> inGoalIDs) {
}

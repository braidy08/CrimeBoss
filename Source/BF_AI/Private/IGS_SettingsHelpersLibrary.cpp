...
bool UIGS_SettingsHelpersLibrary::GetIsInRangeOfCurrentTarget(AIGS_AIControllerBase* InController, const bool inForceMelee) {
    return false;
}
...
float UIGS_SettingsHelpersLibrary::GetCombatRangeMin(AIGS_AIControllerBase* InController, const bool inRawValue) {
    return 0.0f;
}

float UIGS_SettingsHelpersLibrary::GetCombatRangeMax(AIGS_AIControllerBase* InController, const bool inRawValue) {
    return 0.0f;
}

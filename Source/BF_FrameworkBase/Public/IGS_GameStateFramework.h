...
#include "IGS_OnLootSecuredByCharacterDelegate.h"
#include "IGS_OnPocketLootChangedBPDelegate.h"
#include "IGS_OnSecuredLootAddedDelegate.h"
#include "IGS_ReservedLootChangedDelegate.h"
...
class BF_FRAMEWORKBASE_API AIGS_GameStateFramework : public AIGS_GameStateBaseWithData {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_MissionResult, meta=(AllowPrivateAccess=true))
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FIGS_ReservedLootChanged OnReservedLootChangedEvent;
...
protected:
    ...
    TMap<FGameplayTag, int32> ReservedLoot;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    TMap<FGameplayTag, int32> GetReservedLoot() const;

...
bool UMETA_CharacterPerksHandling::IsClassPerk(const FMETA_PerkData& inPerk) {
    return false;
}
...
FText UMETA_CharacterPerksHandling::GetPerkName(const UObject* inWCO, const FGameplayTag inPerkID) {
    return FText::GetEmpty();
}

FText UMETA_CharacterPerksHandling::GetPerkBaseName(const UObject* inWCO, const FGameplayTag inPerkID) {
    return FText::GetEmpty();
}
...
void UMETA_CharacterPerksHandling::GetCombinedPerkStats(const UObject* inWCO, const UMETA_PerkStatsData* inPerkStatsData, const FGameplayTag inPerkID, bool& outSuccess, TMap<FMETA_PerkStatGroup, float>& outStats) {
}

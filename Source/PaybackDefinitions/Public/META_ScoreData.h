...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<EMETA_CareerCompletionReason, float> GameOverReasonMultiplier;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<int32> ScorePerPromotion;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    int32 GetScoreForStars(const int32 inStars) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetGameOverReasonMultiplier(EMETA_CareerCompletionReason inGameOverReason) const;

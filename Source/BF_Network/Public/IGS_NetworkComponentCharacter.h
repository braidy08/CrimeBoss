...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_DamageImmunityActive, meta=(AllowPrivateAccess=true))
    bool mR_DamageImmunityActive;
...
protected:
    UFUNCTION(BlueprintCallable)
    void OnRep_DamageImmunityActive() const;

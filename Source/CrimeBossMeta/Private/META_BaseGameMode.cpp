...
UMETA_WarManagerComponent* AMETA_BaseGameMode::GetWarManagerComponent_Implementation() const {
    return NULL;
}
...
UMETA_StatisticsManagerComponent* AMETA_BaseGameMode::GetStatisticsManagerComponent_Implementation() const {
    return NULL;
}
...
UMETA_PlayerManagerComponent* AMETA_BaseGameMode::GetPlayerManagerComponent_Implementation() const {
    return NULL;
}

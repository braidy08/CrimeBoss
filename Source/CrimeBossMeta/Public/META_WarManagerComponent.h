...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetGangArmyTier(const EMETA_Gang inGang, const EMETA_ArmyTier inArmyTier, const int32 inSpecialTierDuration);
    ...
    bool IsThereGangInAttitudeList(const EMETA_GangAttitudeList inAttitudeList, const EMETA_Gang inOwnerGang, const EMETA_Gang inTargetGang);
    ...
    UFUNCTION(BlueprintCallable)
    bool GetGangAttitudeList(const EMETA_GangAttitudeList inAttitudeList, const EMETA_Gang inOwnerGang, TMap<EMETA_Gang, int32>& outAttitudeList);
    
    UFUNCTION(BlueprintCallable)
    bool GetGangAttitudeDuration(EMETA_GangAttitudeList inAttitudeList, EMETA_Gang inOwnerGang, const EMETA_Gang inTargetGang, int32& outDays);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool DoesGangHaveSpecialArmyTier(const EMETA_Gang inGang) const;
    ...
    UFUNCTION(BlueprintCallable)
    bool CheckMutualGangRelationship(const EMETA_GangAttitudeList inRelation, const EMETA_Gang inFirstGang, const EMETA_Gang inSecondGang, int32& OutDuration);
    
    UFUNCTION(BlueprintCallable)
    void ChangeGangExistingDurationInAttitudeList(const EMETA_GangAttitudeList inAttitudeList, const EMETA_Gang inOwnerGang, const EMETA_Gang inTargetGang, const int32 inByValue);
    
    UFUNCTION(BlueprintCallable)
    void ChangeGangDurationInAttitudeList(const EMETA_GangAttitudeList inAttitudeList, const EMETA_Gang inOwnerGang, const EMETA_Gang inTargetGang, const int32 inByValue, const int32 inLimit);

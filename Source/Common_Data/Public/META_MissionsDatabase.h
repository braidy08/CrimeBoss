...
#include "META_BossKilledMissionOverride.h"
...
static FMETA_MissionDatabase GetMissionDataBP(const UObject* inWCO, TSubclassOf<UMETA_MissionID> inClass, bool& outSucceeded);
    ...
    UFUNCTION(BlueprintCallable)
    FMETA_BossKilledMissionOverride GetBossKilledMissionOverride(TSubclassOf<UMETA_MissionID> inMissionID, bool& outShouldOverride);
